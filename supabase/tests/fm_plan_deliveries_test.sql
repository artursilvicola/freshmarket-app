...
select pg_temp.ok((select 'application/json' = any(allowed_mime_types) and file_size_limit >= 2097152 from storage.buckets where id='fm-plan-cards'),'bucket accepts application/json manifests');
