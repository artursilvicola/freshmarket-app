...
- **Do klienta**: 22 firmy FM bez „Produktów" nic nie pokażą, dopóki nie uzupełnią pola w profilu (lista w czacie 17.09); Fungi Team P&P Rymuza ma pustą listę kategorii — ustawić „warzywa" przed przeliczeniem 23.09 (import do kolejek: firma bez kategorii = `unrouted`). Kategorii „grzyby" nie ma i nie dodajemy przed wydarzeniem.
