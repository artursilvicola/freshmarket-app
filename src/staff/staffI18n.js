...
const DICT = {
  pl: {
    ...
    quick_switch_title: "Twoje sieci — przełącz jednym dotknięciem", quick_switch_selected: "Wybrane stanowisko",
    offline: "Brak połączenia z siecią — przyciski zablokowane. Ostatni znany stan może być nieaktualny.",
    pick_station: "Wybierz stanowisko", no_stations: "Brak przypisanych stanowisk na dzisiejszy dzień. Poproś organizatora o przypisanie do sieci (konto działa tylko w dniu, na który zostało założone).",
    stations_for: (d) => `stanowiska na ${d}`,
    ...
    returnee_count: n => `Czekają powracający: ${n}`,
    returnee_ready_now: "Może już wejść — wybierz „Obsłuż powracającego”.",
    returnee_ready_busy: "Może wejść po zwolnieniu stanowiska.",
    returnee_choice_title: "Czeka powracający — wybierz następny krok",
    btn_serve_company: "Obsłuż tę firmę",
    btn_confirm_serve_company: "Potwierdź — obsłuż firmę",
    returnee_confirm_title: "Potwierdź obsługę powracającego",
    returnee_select_label: "Wybierz powracającą firmę",
    returnee_finish_first: "Najpierw zakończ bieżące spotkanie, potem wybierz firmę.",
    returnee_private_hint: "Tylko dla obsługi. Powracający wchodzi poza tablicą — jego numer nie jest ponownie wywoływany publicznie.",
    returnee_choice_changed: "Stan stanowiska zmienił się. Zamknij to okno i sprawdź aktualną kolejkę.",
    btn_finish_serve_returnee: "Zakończ i obsłuż powracającego",
  ...
  en: {
    ...
    quick_switch_title: "Your retailers — tap to switch", quick_switch_selected: "Selected desk",
    offline: "No network — buttons disabled. The last known state may be outdated.",
    pick_station: "Choose a desk", no_stations: "No desks assigned for today. Ask the organiser to assign you to a retailer (the account works only on the day it was created for).",
    stations_for: (d) => `desks for ${d}`,
    ...
    returnee_count: n => `Returnees waiting: ${n}`,
    returnee_ready_now: "Ready to enter — choose “Serve returnee”.",
    returnee_ready_busy: "Ready once this desk is free.",
    returnee_choice_title: "A returnee is waiting — choose the next step",
    btn_serve_company: "Serve this company",
    btn_confirm_serve_company: "Confirm — serve company",
    returnee_confirm_title: "Confirm serving a returnee",
    returnee_select_label: "Choose a returning company",
    returnee_finish_first: "Finish the current meeting first, then choose a company.",
    returnee_private_hint: "Staff only. The returnee is served off board — their number is not called again on the public display.",
    returnee_choice_changed: "The desk state has changed. Close this dialog and check the current queue.",
    btn_finish_serve_returnee: "Finish and serve returnee",
