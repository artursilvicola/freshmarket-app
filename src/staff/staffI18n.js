...
const DICT = {
  pl: {
    ...
    filters: { all: "Wszystkie", waiting: "Oczekujące", active: "Wywołane / w trakcie", done: "Zakończone", absent: "Nieobecni / powracający" },
  ...
  en: {
    ...
    filters: { all: "All", waiting: "Waiting", active: "Called / in progress", done: "Finished", absent: "No-shows / returnees" },
