...
import {
  ...
  stationLabelFor, fmtClock, isException, meetingName,
} from "./meetingList.js";
...
describe("status pochodzi z rekordu, nie z numeru", () => {
  ...
  it("liczniki filtrów", () => {
    expect(countByFilter(AUCHAN)).toEqual({ all: 9, waiting: 2, active: 2, done: 3, absent: 2 });
  });
});
