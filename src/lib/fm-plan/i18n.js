...
export const T = {
  pl: {
    ...
    th_sup: "Dostawca", th_person: "Osoba · telefon", th_notes: "Notatki",
    contacts_in_app: "Dane kontaktowe dostawców, z którymi mają Państwo spotkania, w tym numery telefonów i adresy e-mail, są dostępne po zalogowaniu w aplikacji Fresh Market B2B:",
    contacts_in_app_after: "Można do nich wrócić również po spotkaniach.",
  ...
  en: {
    ...
    th_sup: "Supplier", th_person: "Contact · phone", th_notes: "Notes",
    contacts_in_app: "Contact details for the suppliers you are meeting, including phone numbers and email addresses, are available after signing in to the Fresh Market B2B app:",
    contacts_in_app_after: "You can return to these details after your meetings.",
